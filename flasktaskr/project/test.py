...
class AllTests(unittest.TestCase):
    ...
    # We can also test for registration error
    ...
    def test_users_can_add_tasks(self):
     ...
     # Error with Users adding tasks (form validation)
    ...
    # Users cannot complete tasks that are not created by them
